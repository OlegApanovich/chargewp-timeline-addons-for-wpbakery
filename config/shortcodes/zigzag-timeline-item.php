...
$params = array_merge(
	[
		...
		[
			'type'        => 'colorpicker',
			'value'       => '#F6A4EC',
			'heading'     => esc_html__( 'Decorative circle color', 'charge-wp-wpbakery-timeline-addons' ),
			'param_name'  => 'decorative_circle_color',
			'description' => esc_html__( 'Select custom color for decorative circle.', 'charge-wp-wpbakery-timeline-addons' ),
		],
		[
			'type'             => 'textfield',
			'value'            => 'Lorem ipsum.',
...
return [
	'name'                    => __( 'Zigzag Timeline Item', 'charge-wp-wpbakery-timeline-addons' ),
	'base'                    => 'wpbakery-plus-zigzag-timeline-item',
	'class'                   => 'wpbakery-plus-zigzag-timeline-item',
	'description'             => __( 'Timeline item for zigzag timeline element.', 'charge-wp-wpbakery-timeline-addons' ),
