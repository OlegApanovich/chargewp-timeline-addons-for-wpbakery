...
$params = array_merge(
	...
	wpbplustimeline_add_custom_font_to_field( 'title', 'Title', array( 'exclude' => array( 'source', 'text', 'css' ) ), array( 'tag', 'text_align' ) ),
	array(
		array(
			'type'             => 'textfield',
			'value'            => 'Feb 2015',
	...
	wpbplustimeline_add_custom_font_to_field( 'date', 'Date', array( 'exclude' => array( 'source', 'text', 'css' ) ), array( 'tag', 'text_align' ) ),
	array(
		array(
			'type'        => 'colorpicker',
			'value'       => '#00c4f3',
...
return array(
	...
	'as_child'                => array( 'only' => 'wpbakery-plus-vertical-timeline' ),
