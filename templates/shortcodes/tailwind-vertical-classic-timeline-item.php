...
<div class="relative flex flex-col sm:flex-row items-center sm:items-center justify-between group" data-aos="fade-up">
...
<div class="relative flex flex-col sm:flex-row items-center sm:items-center justify-between group" data-aos="fade-up">
	<div class="w-full sm:w-[48%] pr-0 sm:pr-[4%] md:pr-[6%] text-center sm:text-right mb-4 sm:mb-0">
		<span class="text-base sm:text-lg md:text-xl font-playfair text-gray-500">2021</span>
		<h3 class="text-lg sm:text-xl md:text-2xl font-playfair text-gray-900 mt-2">Visual Storytelling</h3>
		<p class="mt-2 text-sm sm:text-base text-gray-600 font-lato">The art of visual narrative reaches new heights with immersive technologies and creative direction.</p>
	</div>
	<div class="absolute left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[3%] h-[3%] min-w-[24px] min-h-[24px] bg-white border-2 border-gray-200 group-hover:border-indigo-500 transition-colors duration-300 rotate-45 hidden sm:block"></div>
	<div class="w-full sm:w-[48%] pl-0 sm:pl-[4%] md:pl-[6%]">
		<img src="https://images.unsplash.com/photo-1542744173-8e7e53415bb0" alt="Visual Story" class="w-full aspect-video object-cover rounded-lg shadow-lg">
	</div>
</div>
